...
/**
 * Wrapper do `react-day-picker` com estilos Tailwind/shadcn em pt-BR.
 *
 * Renderiza calendário mensal com navegação prev/next, suporta seleção
 * única ou múltipla via prop `mode`. Usado dentro de Popover pra formar
 * o DatePicker.
 */
